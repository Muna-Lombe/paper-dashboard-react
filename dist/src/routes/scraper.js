...
validator("json", (value, c) => {
    ...
    try {
        const decoded = jwt.verify(apiToken, c.env.JWT_SECRET || "default_jwt_secret");
...
validator("json", (value, c) => {
    ...
    try {
        ...
        //     );
        const canBookBeSharedResponse = await courseScraper.copyCourse(bookId, userId, token);
        ...
        const copyCourseResponse = await courseScraper.copyCourse(bookId, userId, token);

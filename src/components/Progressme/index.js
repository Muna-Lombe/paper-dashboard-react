  ...
  return (
    ...
    <Row className='my-4' style={{ height: 'fit-content' }}>
      <Col>
        ...
        {/*  */}
        <div>
          <ul role="tablist" className="nav nav-pills-primary nav-pills nav-pills-icons justify-content-start ml-4  py-2 col-8 bg-white ">
            ...
            <li key={3} className="nav-item">
              <a data-toggle="tab" role="tab" href="#schedule-builder" className={"nav-link"+(activeTab === "schedule-builder" ? " active" : "")} onClick={()=>setActivetab("schedule-builder")}>
                <div>
                  <span><i className="nc-icon nc-shop"></i> Schedule Builder </span>
                </div>
              </a>
            </li>
          </ul>

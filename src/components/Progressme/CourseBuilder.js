    ...
    return ( 
      <FormGroup style={{
        ...
        <motion.div
          ...
          drag="y">
            <Label for={"text-block-" + ind+ 1}>Text block {ind+ 1}:</Label>
            <Input form="text-block-editable-form" type="text" name={"block-" + ind+ 1} id={"text-block-" + ind+ 1} placeholder="text" defaultValue={block.data}  />
